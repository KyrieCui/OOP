...
public class MyFrame extends JFrame{
	public MyFrame() {
		...
		add(p1,BorderLayout.PAGE_START);	//put the first panel on the top
		add(p2,BorderLayout.CENTER);		//put the second panel on the center
		add(p3,BorderLayout.PAGE_END);		//put the third panel on the bottom
