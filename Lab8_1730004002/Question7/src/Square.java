...
public class Square extends Rectangle {
	...
	public static void testSquare() {
		...
		}	//try to resize with the same newWidth and newLength
		System.out.println(s.area()==100.0); 	
		try {
			s.resize(4.0,7.0);	//try resize the square with different width and length
		}
		catch(Exception e) {
			System.out.println(e.getMessage()=="Cannot resize a Cannot resize a square into a rectangle!");
		}	//try to resize with the different width and length
	}
}
