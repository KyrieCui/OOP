...
public abstract class Building implements Consumer,Serializable{
	...
	public abstract void morePower(int amount) throws Exception;	//override the morePower method in the interface to increase the amount of power generated or consumed by a building
