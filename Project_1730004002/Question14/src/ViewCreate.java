...
public class ViewCreate extends View<ControllerCreate> implements Serializable{
	private JTextField t1;
	private JTextField t2;
	private JComboBox<String> cb;
	public ViewCreate(ElectricityCompany m, ControllerCreate c) {
		super(m,c);
		this.setTitle("View Create");	//add a title
		this.setSize(300,200);	//set the size
		this.setLayout(new GridLayout(4,1));	//add a Gridlayout
